...
from hermes_cli.config import get_env_path, get_env_value, get_nchat_home, load_config
...
def show_status(args):
    ...
    jobs_file = get_nchat_home() / "cron" / "jobs.json"
    if jobs_file.exists():
        import json
        try:
    ...
    sessions_file = get_nchat_home() / "sessions" / "sessions.json"
