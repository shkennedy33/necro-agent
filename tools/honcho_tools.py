...
registry.register(
    ...
    emoji="🔮",
    description_compact="Get user peer card from Honcho.",
)
...
registry.register(
    ...
    check_fn=_check_honcho_available,
    emoji="🔮",
    description_compact="Semantic search of Honcho memory.",
)
...
registry.register(
    ...
    check_fn=_check_honcho_available,
    emoji="🔮",
    description_compact="Query Honcho memory with a question.",
)
...
registry.register(
    ...
    check_fn=_check_honcho_available,
    emoji="🔮",
    description_compact="Write a fact about the user to Honcho.",
)
