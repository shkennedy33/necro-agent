...
registry.register(
    ...
    emoji="🌐",
    description_compact="Navigate a headless browser to a URL.",
)
registry.register(
    name="browser_snapshot",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="📸",
    description_compact="Take a screenshot of the current browser page.",
)
registry.register(
    name="browser_click",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="👆",
    description_compact="Click an element on the browser page.",
)
registry.register(
    name="browser_type",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="⌨️",
    description_compact="Type text into a browser input.",
)
registry.register(
    name="browser_scroll",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="📜",
    description_compact="Scroll the browser page.",
)
registry.register(
    name="browser_back",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="◀️",
    description_compact="Navigate back in browser history.",
)
registry.register(
    name="browser_press",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="⌨️",
    description_compact="Press a key in the browser.",
)
registry.register(
    name="browser_close",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="🚪",
    description_compact="Close the browser session.",
)
registry.register(
    name="browser_get_images",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="🖼️",
    description_compact="List images on the current browser page.",
)
registry.register(
    name="browser_vision",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="👁️",
    description_compact="Analyze the current browser page visually.",
)
registry.register(
    name="browser_console",
    toolset="browser",
    ...
    check_fn=check_browser_requirements,
    emoji="🖥️",
    description_compact="Read browser console output.",
)
