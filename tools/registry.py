...
class ToolEntry:
    ...
    __slots__ = (
        ...
        "requires_env", "is_async", "description", "description_compact", "emoji",
    )
    ...
    def __init__(self, name, toolset, schema, handler, check_fn,
        ...
        self.description_compact = description_compact
        self.emoji = emoji
...
class ToolRegistry:
    ...
    def register(
        ...
        self._tools[name] = ToolEntry(
            ...
            description_compact=description_compact,
            emoji=emoji,
        )
    ...
    def get_definitions(
        self, tool_names: Set[str], quiet: bool = False, compact: bool = False,
    ) -> List[dict]:
        ...
        When ``compact=True``, swap in the compact description for tools
        that have one registered. This saves ~2,000 tokens per API call
        for Opus/Sonnet which don't need verbose tool instructions.
        """
        result = []
        for name in sorted(tool_names):
            ...
            if entry.check_fn:
                try:
                    ...
                    continue
            schema = entry.schema
            if compact and entry.description_compact:
                # Shallow-copy the schema and swap description
                schema = dict(schema)
                schema["description"] = entry.description_compact
